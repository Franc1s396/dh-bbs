...
public class CodeGeneration {
    ...
    void generate(){
        ...
        pc.setModuleName("")//最上级的文件夹名字 不理解就看项目结构
                .setParent("org.francis.dh.app")//在什么文件夹下生成
        ...
        strategy.setInclude("sys_user_role","sys_menu","sys_oper_log","sys_perms","sys_role_menu","sys_role","sys_role_perms","sys_user")//设置要映射的表名
