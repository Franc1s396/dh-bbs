package org.francis.dh.framework.aspect;
...
import org.francis.dh.common.enums.BusinessStatus;
import org.francis.dh.common.utils.SecurityUtils;
import org.francis.dh.common.utils.ServletUtils;
import org.francis.dh.common.utils.StringUtils;
import org.francis.dh.common.utils.ip.IpUtils;
...
public class LogAspect {
     ...
     * @param joinPoint 切点
     */
    @AfterReturning(pointcut = "@annotation(controllerLog)", returning = "respResult")
    public void doAfterReturning(JoinPoint joinPoint, Log controllerLog, Object respResult) {
        handleLog(joinPoint, controllerLog, null, respResult);
    }
